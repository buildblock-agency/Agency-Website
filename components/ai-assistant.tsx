              ...
              {error && (
                <div className="flex justify-center">
                  <div className="bg-destructive/10 text-destructive text-[11px] px-4 py-2 rounded-lg border border-destructive/20 max-w-[85%] text-center">
                    Connection Error. Check API keys.
                  </div>
                </div>
              )}
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-4 border-t border-border bg-background">
              <div className="relative flex items-center">
                ...
                <button
                  ...
                  className="absolute right-2 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center disabled:opacity-50 transition-opacity"
                >
